  ...
  return (
    <>
      <div className='flex justify-between items-center p-3 md:px-20'>
        ...
        {/* logout */}
        <button onClick={logout} className='flex items-center bg-black text-white rounded px-3 py-3 hover:bg-gray-800 hover:text-white '>< FaPowerOff className='me-3'/>LOG OUT</button>
      </div>
      {/* header lower part */}
