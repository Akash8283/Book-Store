      ...
      <div className='col-span-4 p-10'>
        ...
        <div className='md:grid grid-cols-4'>
          ...
          <div className="md:px-5 my-5 md:my-0">
             <div className="bg-green-200 p-4 flex items-center justify-center rounded ">
              {/* icon */}
          ...
          {/* block 2 */}
          <div className="md:px-5 my-5 md:my-0">
             <div className="bg-blue-200 p-4 flex items-center justify-center rounded ">
              {/* icon */}
          ...
          {/* block 3 */}
          <div className="md:px-5 my-5 md:my-0">
             <div className="bg-red-200 p-4 flex items-center justify-center rounded ">
              {/* icon */}
          ...
          {/* block 4 */}
          <div className="md:px-5 my-5 md:my-0">
             <div className="bg-violet-200 p-4 flex items-center justify-center rounded ">
              {/* icon */}
        ...
        <div className='md:grid grid-cols-2 mt-10'>
          ...
          <h3 className='text-xl font-bold'>Montly Purchase Analysis (bar chart)</h3>
        </div>
        {/* chart */}
